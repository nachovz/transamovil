...
(function ($) {
    ...
    var methods = {
        ...
        _equals2: function (field, rules, i, options) {
            ...
            if (field.val() != $("#" + equalsField).val())
                return options.allrules.equals2.alertText;
        },
        /**
        ...
        _ajax: function (field, rules, i, options) {
            ...
            if (!options.isError && !methods._checkAjaxFieldStatus(field.attr("id"), options)) {
                ...
                return rule?rule.alertTextLoad:'';
            }
        },
        /**
    ...
    $(function () {
        $.validationEngine.defaults.promptPosition = methods.isRTL() ? 'topLeft' : "centerRight"
    });
})(jQuery);
