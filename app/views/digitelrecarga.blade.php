...
<div id="container_home4">
	...
	<div id="aux_recarga">
		{{Form::open(array('id' => 'aidi', 'method' => 'get', 'route' => 'digitelrecargaconfirmar'))}}
		...
		{{Form::text( 'numero_afiliado', Session::has('numero_digitel') ? Session::get('numero_afiliado') : null, array('pattern' => '.{7,7}', 'class' => 'validate[required, custom[integer], minSize[7]] nuevocelular', 'id' => 'campo_registro3aa') )}}<br>
	...
	<div class="buttons_6" style="top: 211px;">
		{{Form::submit('', array('id' => 'boton_continuar')) . Form::close()}}&nbsp;&nbsp;&nbsp;<a href="{{URL::route( 'home2' )}}" id="faki8"><img src="img/cancelar_2.png"></a>
	</div>
