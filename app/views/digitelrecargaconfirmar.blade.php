...
<div id="container_home4">
	...
	<div class="buttons_6" style="top: 190px; width:494px">
		<a href="{{URL::route( 'modal_recarga_confirmar', array( Input::get('monto'), Input::get('servicio'), Input::get('numero_afiliado'), Input::get('metodo_pago') ) )}}" class="clsVentanaIFrame3"><img src="img/confirmar.png" class="img_space"></a>
