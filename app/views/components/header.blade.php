...
<div id="regist"><a href="{{URL::route( 'registro' )}}" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('ingresar','','img/buttons/ingresar_over.jpg',1)"><img src="img/buttons/ingresar_up.jpg" width="80" height="22" id="ingresar" border="0" style="display:block"/></a></div><!--regist-->
