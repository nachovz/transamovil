...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="10%"><a href="{{URL::route( 'quienessomos' )}}">QUIÉNES SOMOS</a></td>
    <td width="6%">&nbsp;</td>
    <td width="9%"><a href="{{URL::route( 'contactanos' )}}">CONTÁCTANOS</a></td>
    <td width="4%">&nbsp;</td>
    <td width="16%"><a href="{{URL::route( 'preguntas' )}}">PREGUNTAS FRECUENTES</a></td>
    <td width="20%">&nbsp;</td>
    <td width="3%"><a href="https://www.facebook.com/TransaMovil" target="_blank" onmouseover="MM_swapImage('fb','','img/fb2.jpg',0)" onmouseout="MM_swapImgRestore()"><img src="img/fb.jpg" width="25" height="23" id="fb" border="0" style="display:block"/></a></td>
