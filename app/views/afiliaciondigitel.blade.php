...
<div style="position:relative">
	...
	<div class="afiliacion_2">
		...
		{{Form::text( 'numero', Session::get('numero'), array('pattern' => '.{7,7}', 'id' => 'campo_registro333', 'required', 'x-moz-errormessage' => 'Introduzca un número (Debe tener 7 dígitos)', 'title' => 'Introduzca un número (Debe tener 7 dígitos)') )}}<br>  
		{{Form::text( 'alias', Session::get('alias'), array('id' => 'campo_registro7', 'required', 'x-moz-errormessage' => 'Introduzca un alias', 'title' => 'Introduzca un alias', 'maxlength' => 10) )}}
	</div>
	<div class="buttons_5">
