...
<html>
	...
	<body>
		<div class="modal_afiliacion_titulo_wrapper">
			<span class="modal_afiliacion_titulo url"  data-redirect="{{URL::to('afiliaciondigitel')}}">MODIFICAR AFILIACION</span>
		</div>
		<div class="modal_afiliacion_texto_wrapper">
            <!--[if IE 8]>
            {{Form::open( array('url' => '/modal/afiliacionDigitelModificarIe', 'method' => 'post') )}}
            <![endif]-->
            <!--[if !IE 8]><!-->
